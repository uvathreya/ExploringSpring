...
hiv_prev_data = None
with pd.ExcelFile('./estimated_hiv_prevelance_indicator.xlsx') as reader:
    hiv_prev_data = pd.read_excel(reader, sheet_name='Data')
    ...
    for ind in hiv_prev_data.index:
        try:
            country_code = pc.country_name_to_country_alpha2(hiv_prev_data["country"][ind], cn_name_format="default")
